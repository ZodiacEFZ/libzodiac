...
public class Rectangle {
    ...
    public Rectangle(Translation2d bottomLeft, Translation2d bottomRight, Translation2d topLeft, Translation2d topRight) {
    ...
    public Rectangle translate(Translation2d translation) {
        return new Rectangle(this.bottomLeft.plus(translation), this.bottomRight.plus(translation), this.topLeft.plus(translation), this.topRight.plus(translation));
    }
    ...
    public boolean contains(Translation2d point) {
        return this.crossProduct(this.topLeft, this.bottomLeft, point) * this.crossProduct(this.bottomRight, this.topRight, point) >= 0 && this.crossProduct(this.bottomLeft, this.bottomRight, point) * this.crossProduct(this.topRight, this.topLeft, point) >= 0;
    }
}
